<%@ Page Title="" Language="C#" MasterPageFile="~/mainMasterPage.master" AutoEventWireup="true" CodeFile="addmembers.aspx.cs" Inherits="addmembers" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <table>
        <tr>
            <td style="color: #EFEFEF; background-color: #552723; font-weight: bold;">
    ...
    <asp:Label ID="lblmsg" runat="server" BackColor="#565656" ForeColor="White"></asp:Label><br />
